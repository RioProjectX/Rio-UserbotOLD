...
async def hack(event):
    range(0, 11)
    await event.edit("Menginstall.")
    await event.edit("Menginstall..")
    await event.edit("Menginstall...")
    await event.edit("Menginstall....")
    await asyncio.sleep(3)
    await event.edit("`Menginstall Files Untuk Hack Private Server...`")
    await asyncio.sleep(3)
    await event.edit("`Target Didapat.`")
    await asyncio.sleep(4)
    await event.edit("`Menginstall... 0%\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(3)
    await event.edit("`Menginstall... 4%\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(2)
    await event.edit("`Menginstall... 8%\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(3)
    await event.edit("`Menginstall... 20%\n█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(2)
    await event.edit("`Menginstall... 36%\n█████████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(3)
    await event.edit("`Menginstall... 52%\n█████████████▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(2)
    await event.edit("`Menginstall... 84%\n█████████████████████▒▒▒▒ `")
    await asyncio.sleep(2)
    await event.edit("`Menginstall... 100%\n████████Installed██████████ `")
    await asyncio.sleep(2)
    await event.edit("`Target files Uploading...\n\nDirecting To Remote  server to hack..`")
    await asyncio.sleep(3)
    await event.edit("Menyambungkan Dan Mengambil token dari my.telegram.org ")
    await asyncio.sleep(3)
